/*
 * ItemRuneDisplay_6387.cpp - 物品和神符显示DLL
 * 支持 Warcraft III 1.24e (版本号 6387 = 1.24.4.6387)
...
//=============================================================================
// War3 1.24e (6387 = 1.24.4.6387) 偏移量
...
void StartMonitoring() {
    ...
    OutputToScreen("|cff00ff00ItemRuneDisplay 已启动！War3 1.24e (6387)|r");
}
...
void StopMonitoring() {
    ...
    OutputToScreen("|cffffff00ItemRuneDisplay 已停止。|r");
}
